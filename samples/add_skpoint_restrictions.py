...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--ulvl-per-blvl', type=int,
                            help='If provided, specifies ulvl requirement per current skill blvl')
    arg_parser.add_argument('--use-reqlevel-as-base', action='store_true',
                            help='If set, use reqlevel in Skills.txt as the base ulvl requirement')
    arg_parser.add_argument('--reqskill-level', type=int,
